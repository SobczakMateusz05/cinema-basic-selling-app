...
<img alt="Login screen" title="Login screen" src="http://imgur.com/GUAUAIL.png" width="400" style="margin-bottom: 15px;"><img alt="Add user screen" title="Add user screen" src="http://imgur.com/d81nK4O.png" width="400"  style="margin-left: 15px; margin-bottom: 15px;">
